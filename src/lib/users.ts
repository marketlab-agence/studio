...
export const MOCK_USERS: MockUser[] = [
  { id: 'usr_1', name: 'Alice Martin', email: 'alice.m@example.com', plan: 'Premium', status: 'Actif', joined: '2023-01-15', phone: '+33 6 11 22 33 44' },
  ...
  { id: 'usr_4', name: 'David Petit', email: 'david.p@example.com', plan: 'Gratuit', status: 'Actif', joined: '2023-04-05', phone: '+1 415 555 2671' },
  { id: 'usr_5', name: 'Eva Lefebvre', email: 'eva.l@example.com', plan: 'Premium', status: 'Actif', joined: '2023-05-12' },
  { id: 'usr_6', name: 'Frank Moreau', email: 'frank.m@example.com', plan: 'Premium', status: 'Actif', joined: '2023-06-18', phone: '+44 7700 900548' },
