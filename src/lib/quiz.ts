  ...
  'workflows': {
    ...
    questions: [
      ...
      },
      {
        ...
        answers: [
          { id: 'a1', text: 'L\'utilisation de branches `release` pour préparer les versions.' },
          { id: 'a2', text: 'La branche `main` est toujours considérée comme stable et prête à être déployée.', isCorrect: true },
          { id: 'a3', text: 'L\'obligation de travailler sans branche, directement sur `main`.' },
          { id: 'a4', text: 'La séparation stricte entre les branches `main` et `develop`.' },
        ],
      },
      {
        id: 'q3',
        ...
        answers: [
          { id: 'a1', text: 'Dans des branches de fonctionnalités qui vivent longtemps.' },
          { id: 'a2', text: 'Dans une branche `develop` qui est fusionnée chaque semaine.' },
          { id: 'a3', text: 'Directement et fréquemment sur la branche principale (`trunk`).', isCorrect: true },
          { id: 'a4', text: 'Uniquement après validation manuelle de chaque ligne de code.' },
        ],
      },
      {
        id: 'q4',
      ...
      },
      {
        ...
        isMultipleChoice: true,
        answers: [
          { id: 'a1', text: 'Intégration continue et feedback rapide.', isCorrect: true },
          { id: 'a2', text: 'Historique de code très simple et linéaire.', isCorrect: true },
          { id: 'a3', text: 'Forte isolation des fonctionnalités sur de longues périodes.' },
          { id: 'a4', text: "Idéal pour les débutants qui ne maîtrisent pas la complexité des branches." },
        ],
      },
    ],
    passingScore: 80,
